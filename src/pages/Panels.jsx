...
const products = getProductsByCategory('panels')
  ...
  return (
    <>
      <div className="page-header">
        <h1 className="page-header-title animate-hero-up delay-0">Composite & Decorative Panels</h1>
        <p className="page-header-desc animate-hero-up delay-1">
          Aluminum composite panels, decorative louvers, and architectural wall solutions.
        </p>
